          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <button
                  onClick={toggleMenu}
                  className={`text-[13px] px-4 py-2 rounded-full transition-all duration-200 flex items-center gap-2 cursor-pointer ${
                    allSecondaryLinks.some((l) => l.href === pathname) ? "font-medium text-fg" : "text-muted hover:text-fg"
                  }`}
                >
                  <span className="flex flex-col gap-[3px]">
                    <span className="block w-3 h-[1.5px] bg-current rounded-full" />
                    <span className="block w-2 h-[1.5px] bg-current rounded-full" />
                  </span>
                  Menu
                </button>
              </div>
              ...
              >
                <div className="w-4 flex flex-col gap-[5px]">
                  <span className="block w-full h-[1.5px] bg-fg transition-all duration-300 origin-center" />
                  <span className="block w-full h-[1.5px] bg-fg transition-all duration-300" />
                  <span className="block w-full h-[1.5px] bg-fg transition-all duration-300 origin-center" />
                </div>
              </button>
            </div>
                  ...
                  >
                    ...
                    <a href="tel:0114333380" className="flex items-center gap-3 text-fg/60 hover:text-accent-orange transition-colors duration-200 group mb-5">
                      <span className="w-8 h-8 rounded-full bg-surface group-hover:bg-accent-orange flex items-center justify-center shrink-0 transition-colors duration-300">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted group-hover:text-white transition-colors">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <a href="#" className="group flex items-center gap-2 px-4 py-2.5 rounded-full bg-surface hover:bg-fg transition-all duration-300">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="text-fg group-hover:text-white transition-colors"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                      ...
                      <a href="#" className="group flex items-center gap-2 px-4 py-2.5 rounded-full bg-surface hover:bg-fg transition-all duration-300">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="text-fg group-hover:text-white transition-colors"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        <span className="text-[13px] font-medium text-fg group-hover:text-white transition-colors">X</span>
                      </a>
                      <a href="mailto:hello@star.com" className="group flex items-center gap-2 px-4 py-2.5 rounded-full bg-surface hover:bg-fg transition-all duration-300">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-fg group-hover:text-white transition-colors"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
