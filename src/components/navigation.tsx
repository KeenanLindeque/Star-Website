          ...
          >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
                    ...
                    {branches.map((branch, i) => (
                      ...
                      >
                        <Link
                          href={branch.href}
                          onClick={closeMenu}
                          className="group flex items-center gap-5 py-5 md:py-6 rounded-xl px-4 -mx-4 border-2 border-transparent hover:border-[var(--branch-color)] transition-all duration-300"
                        ...
                        >
                          ...
                          />
                          <span className="hidden md:block text-sm text-muted ml-auto max-w-[200px] text-right transition-colors duration-300">{branch.desc}</span>
                          <ArrowUpRight size={18} className="text-line group-hover:text-[var(--branch-color)] transition-colors duration-300 shrink-0" />
                        </Link>
                      </motion.div>
                    ))}
                  </div>
                ...
                <div className="md:col-span-5 md:border-l md:pl-8" style={{ borderColor: "var(--color-line)" }}>
                  ...
                  >
                    ...
                    <a href="tel:0114333380" className="flex items-center gap-3 text-fg/60 hover:text-accent-orange transition-colors duration-200 group mb-3">
                    ...
                    <a href="https://wa.me/27114333380" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-fg/60 hover:text-[#25D366] transition-colors duration-200 group mb-5">
                      <span className="w-8 h-8 rounded-full bg-surface group-hover:bg-[#25D366] flex items-center justify-center shrink-0 transition-colors duration-300">
                      ...
                      <span className="text-sm font-medium text-fg group-hover:text-[#25D366] transition-colors">WhatsApp</span>
                    </a>
              ...
              <motion.div
                ...
                style={{ borderTop: "1px solid var(--color-line)" }}
              >
                <span className="text-[11px] text-subtle">&copy; 2026 Star. All rights reserved.</span>
              </motion.div>
            </motion.div>
          </motion.div>
        )}
