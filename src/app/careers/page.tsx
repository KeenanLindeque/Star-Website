      ...
      <section className="pt-40 pb-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div {...fadeUp} className="max-w-3xl">
            <div className="w-10 h-px bg-accent-orange mb-8" />
            <h1
            ...
            <p className="text-white/60 text-lg md:text-xl leading-relaxed mt-8 max-w-xl">
      ...
      <section className="pb-32 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div {...fadeUp} className="mb-12">
            <span className="text-[11px] uppercase tracking-widest text-white/40 font-medium">Open positions</span>
