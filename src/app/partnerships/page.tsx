...
const partnerTypes = [
  ...
  { icon: FileCheck, title: "Vendor Registration", description: "Register as an approved vendor to supply goods, services, or specialised expertise to Star Group and its branches." },
...
export default function PartnershipsPage() {
  return (
    <div>
      ...
      {/* Registration Process Timeline — now first */}
          ...
          <div className="relative">
            ...
            <div className="space-y-12 md:space-y-16">
              {registrationSteps.map((item, i) => (
                ...
                >
                  {/* Content */}
                  <div className={`flex-1 ml-14 md:ml-0 ${i % 2 === 0 ? "md:text-right" : "md:text-left"}`}>
